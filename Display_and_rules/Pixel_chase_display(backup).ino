 ...
 *  - maybe we should be using fixed patterns ? + 1/5 of the time it is random
 *  - possible to hit 2 or more "pixels" at the same time
 *  - 6 difficulty for patterns : (Insane ?), Super Hard, Hard, Normal, Easy + Special
 *  - Special pattern can be triggered by doing something special in the game
 ...
 *  2 patterns alternatifs qui changent toutes les secondes par exemple
 *  
 */
